...
/**
 * 作用：二维码识别（图片） 作者：Tiddler 时间：2018-08-2018/8/31 16：23 类名：QRCodeTools
 **/
public class QRCodeTools {
	...
	public static String deEncodeByBase64(String baseStr) {
		...
		try {
			...
			ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(b);// byte[]
																					// 转BufferedImage
	...
	public static void main(String[] args) {
		String content = deEncodeByPath("F:/desktop/111.png");
